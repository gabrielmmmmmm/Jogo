...
export class BossScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.bossBullets = this.physics.add.group({ defaultKey: 'bossBullet', maxSize: 120 });
  ...
  _createTexturesIfMissing() {
    ...
    if (!this.textures.exists('trashBagPellet')) {
      ...
      g.fillStyle(0x0d6b2d, 1);
      g.fillRoundedRect(1, 3, 12, 10, 5);
      g.fillStyle(0x0a3f1c, 1);
      g.fillRoundedRect(3, 5, 8, 6, 4);
      g.fillStyle(0x0d6b2d, 1);
      g.fillTriangle(5, 2, 9, 2, 7, 5);
      g.fillStyle(0xffffff, 0.08);
      g.fillRect(4, 7, 3, 1);
      g.lineStyle(1, 0xeaeaea, 0.10);
      g.strokeRoundedRect(1.5, 3.5, 11, 9, 5);
    ...
    if (!this.textures.exists('trashBagBolt')) {
      ...
      g.fillRect(5, 7, 3, 1);
      g.lineStyle(1, 0xeaeaea, 0.10);
      g.strokeRoundedRect(1.5, 3.5, 13, 9, 5);
    ...
    if (!this.textures.exists('trashBoss')) {
      const g = this.add.graphics();
      // Pixel-ish trash chunk (black bag / debris)
      g.fillStyle(0x0d6b2d, 1);
      g.fillRoundedRect(1, 2, 14, 12, 5);
      g.fillStyle(0x0a3f1c, 1);
      g.fillRoundedRect(3, 4, 10, 8, 4);
      g.fillStyle(0x0d6b2d, 1);
      g.fillTriangle(6, 1, 10, 1, 8, 4);
      g.fillStyle(0xffffff, 0.10);
      g.fillRect(4, 6, 3, 1);
      g.lineStyle(1, 0xeaeaea, 0.12);
      g.strokeRoundedRect(1.5, 2.5, 13, 11, 5);
      g.generateTexture('trashBoss', 16, 16);
      g.destroy();
    }
  }
  ...
  _bossShootPattern() {
    ...
    const fireBullet = (x, y, vx, vy, life = 2200) => {
      const b = this.bossBullets.get(x, y, 'trashBoss');
      if (!b) return;
      b.setActive(true);
      b.setVisible(true);
      b.body.enable = true;
